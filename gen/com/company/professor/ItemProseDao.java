...
/** 
 * DAO for table "item_prose".
*/
public class ItemProseDao extends AbstractDao<ItemProse, Long> {

    public static final String TABLENAME = "item_prose";

    /**
     * Properties of entity ItemProse.<br/>
    ...
    */
    ...
    public ItemProseDao(DaoConfig config) {
        super(config);
    }
    
    public ItemProseDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"item_prose\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_item_prose_item_id_local_language_id ON item_prose" +
                " (\"item_id\",\"local_language_id\");");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"item_prose\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ItemProse entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(ItemProse entity) {
    ...
    /** @inheritdoc */
    @Override
    public ItemProse readEntity(Cursor cursor, int offset) {
        ItemProse entity = new ItemProse( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ItemProse entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ItemProse entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ItemProse entity) {
        if(entity != null) {
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM item_prose T");
    ...
    protected ItemProse loadCurrentDeep(Cursor cursor, boolean lock) {
        ItemProse entity = loadCurrent(cursor, 0, lock);
    ...
    public ItemProse loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<ItemProse> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<ItemProse> list = new ArrayList<ItemProse>(count);
    ...
    protected List<ItemProse> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<ItemProse> queryDeep(String where, String... selectionArg) {
